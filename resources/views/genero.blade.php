...
@section('title', 'Comite de Genero')

@section('content_header')
<h1><center>Generador de Diploma para Comite de Genero</center></h1>
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="{{ asset('vendor/adminlte/dist/img/genero.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Script principal -->
<script src="{{ asset('js/genero.js') }}" defer></script>
@endsection
