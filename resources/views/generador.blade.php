...
@section('title', 'Diploma General 1')

@section('content_header')
<h1><center>Generador de Diploma General 1</center></h1>

<link rel="stylesheet" href="{{ asset('css/diploma.css') }}">
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="{{ asset('vendor/adminlte/dist/img/diploma.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Script principal -->
<script src="{{ asset('js/diploma.js') }}" defer></script>
@endsection
