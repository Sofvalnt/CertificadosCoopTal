...
<div class="container-fluid">
    ...
    <div class="contenedor-imagen">
        <div class="marco-imagen">
            <img src="{{ asset('vendor/adminlte/dist/img/reconocimiento.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Script principal -->
<script src="{{ asset('js/reconocimiento.js') }}"></script>
@stop