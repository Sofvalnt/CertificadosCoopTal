...
@section('title', 'Diploma General 2')

@section('content_header')
<h1><center>Generador de Diploma General 2</center></h1>

<link rel="stylesheet" href="{{ asset('css/general2.css') }}">
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="{{ asset('vendor/adminlte/dist/img/general2.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Script principal -->
<script src="{{ asset('js/general2.js') }}" defer></script>
@endsection
