...
@section('title', 'Comite de Educacion')

@section('content_header')
<h1><center>Generador de Diplomas para Comité de Educación</center></h1>

<link rel="stylesheet" href="{{ asset('css/educacion.css') }}">
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="{{ asset('vendor/adminlte/dist/img/educacion.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Aquí se generan los diplomas sin tocar el resto del contenido -->
...
<!-- Script principal -->
<script src="{{ asset('js/educacion.js') }}" defer></script>
@endsection
