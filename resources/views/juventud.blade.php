...
@section('title', 'Comite de Juventud')

@section('content_header')
<h1><center>Generador de Diploma para Comite de Juventud</center></h1>

<link rel="stylesheet" href="{{ asset('css/juventud.css') }}">
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="{{ asset('vendor/adminlte/dist/img/juventud.png') }}" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<!-- Script principal -->
<script src="{{ asset('js/juventud.js') }}" defer></script>
@endsection
