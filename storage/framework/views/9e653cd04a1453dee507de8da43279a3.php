...
<?php $component->withAttributes(['submit' => 'updateProfileInformation']); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Informacion de perfil')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Actualice la información del perfil y la dirección de correo electrónico de su cuenta.')); ?>
...
<?php $component->withAttributes(['class' => 'mt-2 me-2','type' => 'button','x-on:click.prevent' => '$refs.photo.click()']); ?>
                    <?php echo e(__('Selecciona una nueva foto')); ?>
...
<?php endif; ?>
            ...
            <!--[if BLOCK]><![endif]--><?php if(Laravel\Fortify\Features::enabled(Laravel\Fortify\Features::emailVerification()) && ! $this->user->hasVerifiedEmail()): ?>
                <p class="text-sm mt-2">
                    <?php echo e(__('Tu correo electronico no esta verfiicado')); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\CertificadosCoopTal\resources\views/profile/update-profile-information-form.blade.php ENDPATH**/ ?>