                            ...
                            <div>
                                <div class="text-xs text-gray-500">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($session->is_current_device): ?>
                                        <span class="text-green-500 font-semibold"><?php echo e(__('Este equipo')); ?></span>
                                    <?php else: ?>
                                        <?php echo e(__('Ultima vez activa')); ?> <?php echo e($session->last_active); ?>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\CertificadosCoopTal\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>