...
<head>
    ...
    <style>
        :root {
            ...
            --tutor-color: #0d0e0d;
            --diploma-bg: url('vendor/adminlte/dist/img/juventud.png');
        }
...
<div class="contenedor-imagen">
    <div class="marco-imagen">
        <img src="vendor/adminlte/dist/img/juventud.png" alt="Imagen" class="imagen-interactiva" id="certificado-preview">
...
<script>
    ...
    function alternarModoOscuro() {
        ...
        if (modoOscuroActivado) {
            ...
            document.getElementById('certificado-preview').src = "vendor/adminlte/dist/img/juventud.png";
        } else {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CertificadosCoopTal\resources\views/juventud.blade.php ENDPATH**/ ?>