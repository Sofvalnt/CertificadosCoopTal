...
<?php $__env->startSection('auth_body'); ?>
    ...
    <form action="https://formspree.io/f/mrbpalol" method="post" id="contact_form">
        ...
        <div class="input-group mb-3">
            <input type="email" name="Correo electronico que requiere cambio de contraseña" class="form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>"
                value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('adminlte::adminlte.email')); ?>"  required autofocus>
...
<?php echo $__env->make('adminlte::auth.auth-page', ['authType' => 'login'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CertificadosCoopTal\resources\views/vendor/adminlte/auth/passwords/email.blade.php ENDPATH**/ ?>