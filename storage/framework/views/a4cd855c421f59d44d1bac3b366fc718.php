...
<li class="nav-item dropdown user-menu">
    ...
    <?php if(config('adminlte.usermenu_image')): ?>
            <img src="<?php echo e(Auth::user()->adminlte_profile_url()); ?>"
...
<?php /**PATH C:\xampp\htdocs\CertificadosCoopTal\resources\views/vendor/adminlte/partials/navbar/menu-item-dropdown-user-menu.blade.php ENDPATH**/ ?>